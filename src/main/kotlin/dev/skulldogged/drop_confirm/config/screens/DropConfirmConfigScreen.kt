...
import dev.skulldogged.drop_confirm.config.DropConfirmConfig.HANDLER
...
import net.minecraft.client.gui.screens.Screen
import dev.skulldogged.drop_confirm.DropConfirm.TRANSLATOR
import dev.skulldogged.drop_confirm.config.ConfirmationMode
import dev.skulldogged.drop_confirm.config.DropConfirmConfig
import dev.skulldogged.drop_confirm.config.widgets.ButtonControl
import dev.skulldogged.drop_confirm.config.widgets.EnumControl
import dev.skulldogged.drop_confirm.config.widgets.SliderControl
import dev.skulldogged.drop_confirm.util.ClientGuiUtils

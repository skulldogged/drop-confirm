package dev.skulldogged.drop_confirm.platform

//? if >=1.20.1 {
import net.minecraft.client.gui./*$ gui_graphics_type {*/GuiGraphics/*$}*/ as PoseStack
import dev.skulldogged.drop_confirm.platform.impl.GuiGraphicsRenderImpl
//?} elif >=1.16.5 {
/*import com.mojang.blaze3d.vertex.PoseStack
import dev.skulldogged.drop_confirm.platform.impl.PoseStackRenderImpl
*///?} else {
/*import dev.skulldogged.drop_confirm.platform.impl.LegacyRenderImpl
*///?}
